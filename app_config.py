...
class Config:
    ...
    if is_heroku:
        ...
        REDIRECT_URL = os.environ.get('HEROKU_REDIRECT_URL') or os.environ.get('REDIRECT_URL')
    else:
        # Local development: Use local redirect URL
        REDIRECT_URL = os.environ.get('LOCAL_REDIRECT_URL') or os.environ.get('REDIRECT_URL') or 'http://localhost:5000/callback'
